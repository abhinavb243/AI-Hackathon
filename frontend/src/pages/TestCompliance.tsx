...
const TestCompliance = () => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Test Compliance Detection</h1>
        <p className="text-muted-foreground">
          Test the AI-powered compliance detection system with mock regulation data
        </p>
      </div>

      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          <TabsTrigger value="regulation">Regulation Data</TabsTrigger>
